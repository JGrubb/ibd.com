...
describe PortfolioItemsController do
  ...
  describe "GET show" do
    it "assigns the requested portfolio_item as @portfolio_item" do
      portfolio_item = PortfolioItem.create! valid_attributes
      get :show, {:id => portfolio_item.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested portfolio_item as @portfolio_item" do
      portfolio_item = PortfolioItem.create! valid_attributes
      get :edit, {:id => portfolio_item.to_param}, valid_session
      assigns(:portfolio_item).should eq(portfolio_item)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new PortfolioItem" do
        expect {
          post :create, {:portfolio_item => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved portfolio_item as @portfolio_item" do
        ...
        post :create, {:portfolio_item => { "title" => "invalid value" }}, valid_session
        assigns(:portfolio_item).should be_a_new(PortfolioItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested portfolio_item" do
        ...
        put :update, {:id => portfolio_item.to_param, :portfolio_item => { "title" => "MyString" }}, valid_session
      end

      it "assigns the requested portfolio_item as @portfolio_item" do
        portfolio_item = PortfolioItem.create! valid_attributes
        put :update, {:id => portfolio_item.to_param, :portfolio_item => valid_attributes}, valid_session
        assigns(:portfolio_item).should eq(portfolio_item)
      end
    ...
    describe "with invalid params" do
      it "assigns the portfolio_item as @portfolio_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        PortfolioItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => portfolio_item.to_param, :portfolio_item => { "title" => "invalid value" }}, valid_session
        assigns(:portfolio_item).should eq(portfolio_item)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested portfolio_item" do
      portfolio_item = PortfolioItem.create! valid_attributes
      expect {
        delete :destroy, {:id => portfolio_item.to_param}, valid_session
      }.to change(PortfolioItem, :count).by(-1)
    end
